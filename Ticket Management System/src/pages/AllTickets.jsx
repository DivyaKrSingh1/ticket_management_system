...
const AllTickets = () => {
    ...
    const fetchTickets = async () => {
        ...
        try {
            ...
            if (employeeFilter) query += `employeeName=${employeeFilter}`;
    ...
    const handleDelete = async (id) => {
        if (window.confirm('Are you sure you want to delete this ticket?')) {
            try {
                await API.delete(`/ticket/${id}/delete`);
    ...
    return (
        <div className="max-w-6xl mx-auto px-4">
            <h2 className="text-2xl font-bold text-indigo-900 mb-6">All Tickets</h2>
